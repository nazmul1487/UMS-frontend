import { get_users } from '@/app/component/service/Api';
...
//   loadUsers();
            ...
            <div className="p-0 md:p-2">
                ...
                <table className="table-auto w-full ">
                    ...
                    <tr key={index}>
                        ...
                        <td className="mx-2 bg-blue-400 text-center w-14 border border-white">
							<button >
  ...
  <path fillRule="evenodd" d="M1.38 8.28a.87.87 0 0 1 0-.566 7.003 7.003 0 0 1 13.238.006.87.87 0 0 1 0 .566A7.003 7.003 0 0 1 1.379 8.28ZM11 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" clipRule="evenodd" />
                        ...
                        <td className="mx-2  text-center bg-yellow-600 w-14 border border-white">
							<button  className="">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4">
  ...
  <path d="M4.75 3.5c-.69 0-1.25.56-1.25 1.25v6.5c0 .69.56 1.25 1.25 1.25h6.5c.69 0 1.25-.56 1.25-1.25V9A.75.75 0 0 1 14 9v2.25A2.75 2.75 0 0 1 11.25 14h-6.5A2.75 2.75 0 0 1 2 11.25v-6.5A2.75 2.75 0 0 1 4.75 2H7a.75.75 0 0 1 0 1.5H4.75Z" />
                        ...
                        <td className="mx-2 bg-red-700 text-center w-14 border border-white">
